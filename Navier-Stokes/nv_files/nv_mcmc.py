...
class NVMCMCDA(MCMCDA):
    def __init__(self,coarse_surrogate,observation_locations, observations_values, nparameters=2, fs_indices_sol = None,
        ...
        mcmc_instance = NVMCMC(surrogate = coarse_surrogate,observation_locations = observation_locations, 
                                    ...
                                    my_reg=my_reg,step_size=step_size, device=device)

        super(NVMCMCDA, self).__init__(observation_locations, observations_values, mcmc_instance, nparameters, 
