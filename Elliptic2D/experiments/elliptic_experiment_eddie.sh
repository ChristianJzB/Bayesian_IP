...
# python Elliptic2D/experiments/elliptic2d_experiment.py --N $N --hidden_layers $NLAYER --num_neurons $NNEURON --batch_size $BATCH --kl $KL $TRAIN $DEEPGALA $NOISE_LEVEL $PROPOSAL $FEM_MCMC_FLAG $NN_MCMC $DGALA_MCMC $DA_MCMC_NN $DA_MCMC_DGALA
# EOF             
#                 done
#             done
#         done
...
CONFIG_MODELS=("3 150 50 10 2" "3 150 100 10 2" "3 150 500 250 2" "3 150 1000 250 2" "3 250 10000 800 3" "3 250 10000 800 4" "3 250 10000 800 5")
